...
ar rcs bin/static/libdfds.a bin/static/binary-search-tree.o bin/static/avl-tree.o bin/static/circular-queue.o bin/static/doubly-linked-list.o bin/static/dynamic-stack.o bin/static/sequential-list.o

g++ bin/main.o -Lbin/static -l:libdfds.a -o bin/statically-linked
